...
case class OIAW(topics : List[Topic], b_uri: String, import_uri : String) extends Construct() {
  ...
  def toOWL() = {
    ...
    <owl:Ontology rdf:about={Construct.base_uri.slice(0, Construct.base_uri.length - 1)}>
      ...
      <owl:AnnotationProperty rdf:about="http://publications.europa.eu/ontology/annotation#documentation">
        <rdfs:label>Unspecified additional documentation or information available for this element</rdfs:label>
      </owl:AnnotationProperty>
